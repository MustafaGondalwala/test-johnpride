...
class ProductController extends Controller{
    ...
    private function exportXls($productQuery){
        ...
        $select = ['id','style_id','sku','name','slug','brand_id','manufacturer','country_origin','business_unit','description','gender','video','color_id','size_chart_id','price','sale_price','gst','weight','delivery_duration','sort_order','stamp','featured','trending','net_qty','product_type','standard_size',
