...
class ProductController extends Controller{
    ...
    private function exportXls($productQuery){
        ...
        $select = ['id','name','slug','sku','brand_id','description','gender','video','color_id','size_chart_id','price','sale_price','weight','delivery_duration','sort_order','stamp','featured','trending','style_id','manufacturer','country_origin','net_qty','business_unit','product_type','standard_size',
