...
class InstagramApi{
    ...
    private $accessToken = 'IGQVJXV1dEQi0xZA1hLaTZAzaVhFMldJSVUzOUVnY1ZAHd3VGalNXUWI0Q0ZAwT01vbWhvWUxpeTBFSEdLRnE4dHVIa3c2Ul9Ud3N3bFl5bjZALaFhkRm1pN0pjOEhFS1RaOUV1QzAxVmVB';
    ...
    function userMedia(){
      ...
      $instagram_url = "https://graph.instagram.com/".$insta_id."/media?fields=id,children,media_type,caption,media_url,username,timestamp,permalink,media&access_token=".$token;
