...
class CityController extends Controller{
    ...
    public function import(Request $request){
        ...
        if($request->method() == 'POST' || $request->method() == 'post'){
            ...
            $result = Excel::import(new CityImport, $file);

            if($result){
                return redirect('admin/cities/import');
            }
            else{
                return redirect('admin/cities/import')->with('err_msg', 'something went wrong, please try again.');
            }
            

        }
        return view('admin.cities.import', $data);
    }
