...
Route::group(['prefix' => 'processjobs', 'as' => 'processjobs'], function(){
    ...
    Route::get('test_order_update', 'ProcessJobsController@test_order_update');   
...
Route::get('/prideonme', 'PrideOnmeController@index');
 ...
 Route::group(['middleware' => 'impersonate'], function(){
    Route::get('/', 'HomeController@index')->name('home_url');

    Route::get('/home_new', 'HomeController@index_test');

});

Route::get('/mail_test', 'HomeController@mail_test');
Route::get('/phone_update', 'TestController@phone_update');
Route::get('/product_remove', 'TestController@product_remove');
...
Route::group(['prefix' => 'account', 'as' => 'account'], function(){
    ...
    Route::post('ajax_login_otp_send', 'AccountController@ajax_login_otp_send');

    Route::post('ajax_register', 'AccountController@ajaxRegister');

    Route::post('ajax_send_otp', 'AccountController@ajaxSendOtp');
    Route::post('ajax_verify_otp', 'AccountController@ajaxVerifyOtp');
...
Route::group(['prefix' => 'users', 'as' => 'users', 'middleware' => ['impersonate','auth']], function(){
    ...
    Route::post('redeem_loyality_point', 'UserController@redeemLoyalityPoints');
...
Route::group(['prefix' => 'products', 'as' => 'products','middleware' => ['impersonate']], function() {
...
Route::group(['prefix' => 'blogs', 'as' => 'blogs.', 'middleware' => ['impersonate']], function() {
...
Route::group(['prefix' => 'cart', 'as' => 'cart', 'middleware' => ['impersonate']], function() {
...
Route::group(['middleware' => 'impersonate'], function()
{
   ...
   Route::match(['get', 'post'], 'order/paysuccess', 'OrderController@paysuccess');
    ...
    Route::match(['get', 'post'], 'order/payfail', 'OrderController@payfail');
     ...
     Route::match(['get', 'post'], 'order/paytmCallBack', 'OrderController@paytmCallBack');

});


Route::group(['prefix' => 'order', 'as' => 'order', 'middleware' => ['impersonate','auth'] ], function() {
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['authadmin']], function() {
    ...
    Route::group(['prefix' => 'customers', 'as' => 'customers'], function() {
        ...
        Route::match(['get', 'post'], 'clogin/{user_id}', 'CustomerController@customer_login')->where(['user_id' => '[0-9]+',])->name('.customer_login');
