                      ...
                      foreach($cartItems as $cart){
                       ...
                       // $inventory_id_arr = $cart['inventories'];
                        ...
                        <tr>
                          ...
                          <td><a class="carttitle" href="{{url('products/detail/'.$product->uri)}}">{{ $product->code }}</a>
                          ...
                          <td><i class="fa fa-inr" aria-hidden="true"></i> {{ number_format($price_per_set, 2) }} + {{trans('custom.gst')}} @ {{$gst}}%</td>
                          <td align="center">
                          ...
                          */$total_price
                          ...
                          <td>
                            ...
                            <form name="itemDeleteForm" method="POST" action="{{url('cart/remove/'.$cart['id'])}}">
                              ...
                              <button type="button" class="btn deletebtn"><i aria-hidden="true" class="fa fa-trash-o"></i><!--<img src="{{url('public/assets/img/del.png')}}" />--></button>
                            </form>
                          </td>
                        </tr>
