								...
								<div class="procont">
									...
									<div class="removeandwish">
										...
										<div class="wishlistmove">
											...
											<i class="wishlistpink"></i>
											<?php
											if($authCheck){

												if(isset($userWishlist[$product->id])){
													?>
													<a href="javascript:void(0)"><span>Wishlisted</span></a>
													<?php
												}
												else{
													?>
													<a href="javascript:void(0)" data-slug="{{$product->slug}}" class="moveToWishlist"><span>Move To Wishlist</span></a>
													<?php
												}
											}
											else{
												?>
												<a href="javascript:void(0)" onclick="gotoLogin()"><span>Move To Wishlist</span></a>
												<?php
											}
											?>


											<!-- <a href="javascript:void(0)" data-slug="" class="moveToWishlist"><span>Move To Wishlist</span></a> -->
										</div>
				...
				$.ajax({
					...
					success: function(resp){
						if(resp.success){
							...
							var modalPopup = $("#alertModal");

							modalPopup.find(".alert").html("Item has been added to wishlist.");
							modalPopup.modal("show");
							currSel.parent().html('<i class="wishlistpink"></i> <a href="javascript:void(0)"><span>Wishlisted</span></a>');
						}
