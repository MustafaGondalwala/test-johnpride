	...
	<div class="addaddress formbox">
		<ul>
			...
			<li class="addresstype"><span>Type of Address<cite>*</cite></span>
				<span>
					<label><input type="radio" name="type" value="home" <?php echo ($type == 'home')?'checked':'';?> /> Home</label>
					<label><input type="radio" name="type" value="office" <?php echo ($type == 'office')?'checked':'';?> /> Office/Commercial</label>
				</span>
			</li>
