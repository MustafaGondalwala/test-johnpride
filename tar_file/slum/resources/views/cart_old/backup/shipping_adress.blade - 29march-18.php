                    ...
                    <div class="col-md-12">
                       ...
                       <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-3">
						...
						<div class=" col-xs-12 col-sm-6 col-md-6 col-lg-3">
							...
							<input id="delivery_address_1" class="form-control  form-control-input" name="delivery_address_1" value="" maxlength="255" required="" type="text">
						</div>
						...
						<div class=" col-xs-12 col-sm-6 col-md-6 col-lg-3">
							...
							<select id="delivery_state" class="state form-control delivery_state  form-control-input" name="delivery_state" data-type="delivery" required="">
						...
						<div class=" col-xs-12 col-sm-6 col-md-6 col-lg-3">
							...
							<input id="delivery_zipcode" class="form-control  form-control-input" name="delivery_zipcode" value="" maxlength="20" required="" type="text">
