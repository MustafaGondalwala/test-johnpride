                ...
                ?>
                  ...
                  <div class="tableCustomNew table-responsive">
                    ...
                    <div class="col-md-9 text-right dataItems">
                      <div class="">
                        <p style="font-size:14px;">Order Subtotal : <i class="fa fa-inr" aria-hidden="true"></i>{{ number_format($total_amount, 2) }}</p>
                        
                        <p style="font-size:14px;">
                          Shipping Charges : <i class="fa fa-inr" aria-hidden="true"></i>{{ number_format($shipping_fee, 2) }}
                          
                      </p>
                        

                        <p style="font-size:14px;">
                          Total GST : <i class="fa fa-inr" aria-hidden="true"></i>{{ number_format($total_order_gst, 2) }}
                          <br>
                          (Order : <i class="fa fa-inr" aria-hidden="true"></i> {{ number_format($total_gst, 2) }} + Shipping : <i class="fa fa-inr" aria-hidden="true"></i> {{ number_format($shipping_gst, 2) }} at {{$gst_arr[0]}}%)
                        </p>

                        <p class="paddingsMicro">Total Amount :&nbsp;<span><i class="fa fa-inr" aria-hidden="true"></i> {{ number_format(round($total_amount_gst),2) }}</span></p>
