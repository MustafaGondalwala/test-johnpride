      ...
      <div class="rightBar">
        <div class="tableArea container-custom">
          <div class="panel panel-default">
            <div class="topHeading panel-heading"> <span></span><span></span><span></span>Shipping Address </div>    
            ...
            <div class="welcomeContent panel-body noPaddings cartpage">
              ...
              <?php 
                ...
                <button onclick="copy_address(<?php echo $del_add->id;?>)" type="button" class="btn btn-primary">Deliver here</button>
                <button onclick="edit_address(<?php echo $del_add->id;?>)" type="button" class="btn btn-default">Edit</button>          
              ...
              <?php } ?>
               ...
               <?php } ?>
                ...
                if(count($cartItems) > 0){
                  ?>
                    ...
                    */
                    ...
                    <div class="col-md-12">
                        ...
                        <label for="delivery-name" class="control-label">GST / Aadhaar:</label>
                        ...
                        */
                        ...
                        <select name="gst_aadhar_type" class="form-control">
                          ...
                          <option value="aadhar_number">Aadhaar</option>
                        </select>
                        ...
                        <input id="gst_aadhar_num" class="form-control" name="gst_aadhar_num" value="" maxlength="255" type="text">
						...
						<div class="row">
                        <div class="form-group col-md-6">
                        <label for="delivery-name" class="control-label required">Shipping Name:</label>

                                <input id="delivery_company_name" class="form-control" name="delivery_company_name"  maxlength="255" value=""  type="text">
                        </div>

                        <div class="form-group col-md-6">
                        <label for="delivery-name" class="control-label required">Contact Name:</label>

                                <input id="delivery_name" class="form-control" name="delivery_name"  maxlength="255" value=""  type="text">
                        </div>
						...
						<div class="form-group">
							<label for="delivery-address-1" class="control-label required">Address Line 1:</label>

							<input id="delivery_address_1" class="form-control" name="delivery_address_1" value="" maxlength="255" required="" type="text">
						</div>

						<div class="form-group">
							<label for="delivery-address-2" class="control-label">Address Line 2:</label>

							<input id="delivery_address_2" class="form-control" name="delivery_address_2" value="" maxlength="255" type="text">
						...
						<div class="row">
						<div class="form-group col-md-6">
							<label for="delivery-state" class="control-label required1">State:</label>

							<select id="delivery_state" class="state form-control delivery_state" name="delivery_state" data-type="delivery" required="">
						...
						<div class="form-group col-md-6">
							...
							<select id="delivery_city" name="delivery_city" class="delivery_city form-control">
							<option value="">--Select--</option>
							 <?php
								/*if(count($cities) > 0){
						...
						<div class="form-group col-md-6">
							...
							<input id="delivery_zipcode" class="form-control" name="delivery_zipcode" value="" maxlength="20" required="" type="text">

						 </div>

						<div class="form-group col-md-6">
							<label for="delivery-phone" class="control-label">Phone Number:</label>

							<input id="delivery_phone" class="form-control" name="delivery_phone" value="" maxlength="20" type="text">
                 ...
                 <input type="hidden" name="is_new_shipping_addr" value="0">

                     <button type="submit" class="btn btn-default deliver_new_addr">Deliver here</button>
                  </div>  
