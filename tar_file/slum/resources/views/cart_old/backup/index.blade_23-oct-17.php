                ...
                if(count($cartItems) > 0){
                  ...
                  <div class="tableCustomNew table-responsive">
                    <table class="tableCustom table">
                      ...
                      foreach($cartItems as $cart){
                        ...
                        <tr>
                          ...
                          if(count($availableInventory) > 0){
                            foreach($availableInventory as $ai){
                              if(isset($inventory_id_arr[$ai->id])){
                                $inventory_id_qty = $inventory_id_arr[$ai->id];
                                //echo "(Size : $ai, Qty : $inventory_id_qty)<br>";
                                echo "<p class='perItem'>(Size : $ai, Qty : $inventory_id_qty)</p>";
                              }
                            }
                          }
                          ?>
                    ...
                    <div class="col-md-9 text-right dataItems">
                      <div class="totalItems">
                        ...
                        <p>(<i class="fa fa-inr" aria-hidden="true"></i> {{$total_amount}} + <i class="fa fa-inr" aria-hidden="true"></i> {{$total_gst}} tax)</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 btnOrder">
                    ...
                    */
                    ...
                    <p>Shipping Charges : <i class="fa fa-inr" aria-hidden="true"></i> 25</p>
