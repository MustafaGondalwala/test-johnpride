...
<form method="POST" id="billing_address_form" action="{{url('cart/shippingaddress')}}" onsubmit="return validate_billing_address()">
		...
		<div class="row">
			...
			<div class="">
			 <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<label for="gst_aadhar_type" class="control-label">GST:</label>
				...
				*/
				...
				<select name="gst_aadhar_type" class="form-control form-control-input">
					<option value="gst" <?php echo ($gst_aadhar_type == 'gst')?'selected':'selected';?> >GST</option>
					<?php
					/*
					<option value="">--Select--</option>
 ...
 <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
	<label for="gst_aadhar_num" class="control-label">GST No. :</label>
...
<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
		...
		<select id="billing-state" class="state form-control form-control-input billing_state" name="billing_state" data-type="billing" required="">
...
<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<br/>
	<input id="is_diffrent_shipping" type="checkbox" name="is_diffrent_shipping" class=" form-control-input" value="1"> My Shipping Address is the same as my Billing Address
...
<div class=" col-md-12">
<div class="btndiv form-control-input"><button id="billing_address_form_sbmbtn " type="submit" class="btn btn-default form-control-input">Next</button></div>
</div>
