                       ...
                       // $inventory_id_arr = $cart['inventories'];
                        ...
                        <tr>
                          ...
                          <td><a class="carttitle" href="{{url('products/detail/'.$product->uri)}}">{{ $cart['product_name'] }}</a>
                            ...
                            <p class="perItem"><i class="fa fa-inr" aria-hidden="true"></i> {{ $product_price }} / pc + GST @5%</p>
                          </td>
                          <td><i class="fa fa-inr" aria-hidden="true"></i> {{ number_format($price_per_set, 2) }} + GST @5%</td>
                          <td>
                          ...
                          <p class='perItem'>(Including GST 5%)</p>
                          </td>
                          <td>
    ...
    <script type="text/javascript">
      function validate_place_order()
      {
        if($("input[name='payment_method']").is(":checked")){
          ...
          $(".cart_sbt_msg").html('<div class="alert alert-danger alert-dismissable" style="display"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Alert!</strong> Please select Payment Method.</div>');
