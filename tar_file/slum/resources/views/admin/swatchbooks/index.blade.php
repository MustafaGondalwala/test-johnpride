    ...
    <div class="row">
        <div class="col-md-12">
			<div class="titlehead">
			<h1 class="pull-left">Swatch Book List ({{ $products->count() }})</h1>

             <a href="{{ route('admin.swatchbooks.add') }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add Swatch Book</a>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    foreach ($products as $product){
                        ...
                        <tr>
                            <td>{{$product->name}}</td>
                            <td>{{$designer_name}}</td>
                            <td><?php echo $CategoryBreadcrumb; ?></td>
                            <td>{{$product->sku}}</td>
                            <td>{{$product->price}}</td>
                            ...
                            <td>
                                <a href="{{route('admin.swatchbooks.edit', ['id'=>$product->id,'back_url'=>$BackUrl])}}" title="Edit"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                        <?php
                    }
