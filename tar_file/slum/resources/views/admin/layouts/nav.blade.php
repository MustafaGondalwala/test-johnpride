<style type="text/css">
	.sub_active a{ color:#f66c1f !important; }
</style>
<div class="leftsec">
			...
			<li <?php echo $master_active; ?> >
				...
				<ul>
					...
					<li {!! strpos(Route::currentRouteName(), 'admin.brands') === 0 ? ' class="sub_active"' : '' !!}>
						<a href="{{ route('admin.brands.index') }}" > <span>Brands</span></a>
					</li>
...
<li {!! strpos(Route::currentRouteName(), 'admin.size_charts') === 0 ? ' class="active"' : '' !!}>
			...
			*/
			...
			<li {!! strpos(Route::currentRouteName(), 'admin.newslettersubscriber') === 0 ? ' class="active"' : '' !!}>
				<a href="{{url('admin/newslettersubscriber')}}" > <span> Newsletter Subscriber</span></a>
			</li>
