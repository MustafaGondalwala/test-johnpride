        ...
        <div class="col-md-12">
            ...
            <form method="POST" action="" accept-charset="UTF-8" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group  col-md-2{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" id="name" class="form-control" name="name" value="{{ old('name', $name) }}" maxlength="255" readonly />
                ...
                <div class="form-group  col-md-2{{ $errors->has('heading') ? ' has-error' : '' }}">
