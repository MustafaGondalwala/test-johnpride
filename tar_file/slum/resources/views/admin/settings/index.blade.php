@component('admin.layouts.main')
    ...
    $title = (isset($settingRow->display_name))?$settingRow->display_name:'';
            ...
            @include('snippets.flash')
                ...
                <br>
                    <form method="POST" action="{{ $action_url }}" accept-charset="UTF-8" role="form" class="form-inline heightform" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-2 {{ $errors->has('value') ? ' has-error' : '' }} ">
                        ...
                        if($setting_id > 0){
                            ?>
                            <a href="{{ url('admin/settings') }}" class="btn resetbtn btn-primary btn1search" title="Cancel">Cancel</a>
                            <?php
                        }
                        ?>
                ...
                <table class="table table-striped">
                    ...
                    @foreach ($settings as $setting)
                        <tr>
                            ...
                            <td>
                                {{(!empty($setting['value']))?$setting['value']:''}}
                            </td>
