...
class CustomerController extends Controller{
    ...
    public function wallet(Request $request){
        ...
        if(is_numeric($user_id) && $user_id > 0){
            ...
            if( $method == 'POST' || $method == 'post' ){
                ...
                $wallet_data['created'] = $created;
                $wallet_data['updated'] = $created;
            ...
            $wallet_list = UserWallet::where('user_id', $user_id)->orderBy('created', 'desc')->get();
    ...
    public function wallet_transaction_emails($wallet_transaction_id){
        ...
        if($wallet_data->credit_amount >0){
            $subject = 'Rs '.$wallet_data->credit_amount.' is created in your wallet';

            $tag_line=  'Rs '.$wallet_data->credit_amount.' is created in your wallet';
        ...
        $is_mail = CustomHelper::SendMail('emails.wallet.wallet_transaction', $email_data, $to=$to_email, $from_email, $replyTo = $from_email, $subject);
    }
