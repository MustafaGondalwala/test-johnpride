...
<section class="fullwidth innerpage payment-layout"> 
  ...
  <div class="row">
    ...
    <form id="frm_order" method="post" action="{{url('order/process')}}">
...
//    if(isset($is_wallet) && $is_wallet == '1' && $walletBalance >= $total){
 ...
 -->
      <div  style="display: none;" class="row">  
        <input type="radio" name="paymentMethod" value="paytm"  required=""> Online Payment<br>

    </div>
    <div class="row">  
        <input type="radio" name="paymentMethod" value="ccavenue"  required=""> Online Payment<br>
 ...
 if($cod_available == 1)
   ...
   ?> 
      ...
      <div class="row">
        ...
        <input class="button" type="submit" id="btnPayment" name="paymentSubmitBtn" value="Continue">
