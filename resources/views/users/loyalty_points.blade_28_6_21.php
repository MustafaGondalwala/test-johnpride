...
<section class="fullwidth innerpage">
 	<div class="container">
		...
		<div class="rightcontent">
			 <div class="main_inner_box loyalty_points">
			<div class="heading2">My Loyalty Points</div>

			<?php if(!empty($loyaltyPointsDetails) && $loyaltyPointsDetails['haveCriteria'])
			{
				?>
				<div class="orderlist ordercontent">
					<div class="nameq"><a href="{{url('users/loyalty-points')}}"><strong><?php echo $loyaltyPointsDetails['name']; ?></strong></a></div>
