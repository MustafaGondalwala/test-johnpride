						...
						<div class="orderheading bgcolor row">
							<div class="col-sm-12">
								...
								<div class="col-sm-6">
									...
									?>
									<button type="button" class="btn btn-success btnCancel noPrint" data-id="{{ $subOrder->id }}" style="background:#a77736;">Cancel Order</button>
									<?php } ?>
									...
									if($subOrder->order_status == 'shipped' || $subOrder->order_status == 'delivered'){
										...
										if($diffDays <= $ORDER_RETURN_DAY){
											?>
											<button type="button" class="btn btn-success btnReturn noPrint" data-id="{{ $subOrder->id }}" style="background: #a77736;">Return Order</button>
											<?php
										}
									}
									?>
										...
										?>
										<button class="print_invoice btn btn-success noPrint" style="background: #a77736;" data-id="{{ $subOrder->id }}">Print Invoice</button>
										<?php } ?>

										<!-- <a href="javascript:void(0)" data-id="{{ $order->id }}" class="print_invoice btn btn-sm btn-success" style="background: #a77736;">Print Invoice</a> -->
