							...
							<div class="col-sm-12">
								...
								<div class="top_orders_sec">
									...
									?>
										...
										<div class="top_orders_sec">
										<label> Payment Status:</label>  <?php echo ($order->payment_status=='receieved')?'Received':$order->payment_status;  ?> 
									</div>
								...
								<div class="col-sm-6">
									...
									$updated_on = CustomHelper::DateFormat($order->updated_at, 'Y-m-d');
									?>

									<?php
									if($order->order_status == 'confirmed'){
									?>
									<button type="button" class="btn btn-success btnCancel noPrint" data-id="{{ $order->id }}" style="background: #e41881;">Cancel Order</button>
									<?php } ?>
									...
									if($order->order_status == 'shipped' || $order->order_status == 'delivered'){
										...
										if($diffDays <= $ORDER_RETURN_DAY){
											?>
											<button type="button" class="btn btn-success btnReturn noPrint" data-id="{{ $order->id }}" style="background: #e41881;">Return Order</button>
											<?php
										}
									}
									?>
										...
										?>
										<button class="print_invoice btn btn-success noPrint" style="background: #e41881;" data-id="{{ $order->id }}">Print Invoice</button>
										<?php } ?>
