		...
		<div class="detailbox fullwidth" id="">
			<ul class="cartlist">
				...
				foreach ($orderItems as $item) {	
					...
					$main_price = isset($product->price) ? $product->price:0;
...
if(is_numeric($sale_price) && $sale_price < $main_price && $sale_price > 0){
...
<div class="cartprice"><span>₹<?php if(!empty($productPrice)){ echo number_format($productPrice); } ?></span></div>
