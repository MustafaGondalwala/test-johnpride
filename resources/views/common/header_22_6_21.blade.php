		...
		<div class="topmenu">
			...
			<ul>
				...
				<li><a class="link_click"  href="javaScript:Void(0)"><span class="desktopshow">Shop</span>
				 ...
				 <span class="mobileshow">Category</span></a>
				...
				foreach ($parentCategories as $category) {
					...
					<li>
						...
						<a class="link_click" href="javaScript:Void(0)"> {{$category->name}} </a> 
				...
				<?php
				  ...
				  if(!empty($collections) && count($collections) > 0) {
				   ...
				   ?>
				     ...
				     <li class="mobilelink"><a class="link_click" href="javaScript:Void(0">Collection</a>
