...
if(!empty($productInventorySize) && count($productInventorySize) > 0)
{
    ...
    if($totalStock > 0)
    {
        $header_stock = 'in stock';
    }
    else
    {
        $header_stock = 'out of stock';
    }
    ...
    ?>
<meta property="product:brand" content="Johnpride">
<meta property="product:availability" content="{{$header_stock}}">
<meta property="product:condition" content="new">
<meta property="product:price:amount" content="{{$productPrice}}">
<meta property="product:price:currency" content="INR">
<meta property="product:retailer_item_id" content="{{$product_sku}}">
    <?php
}
