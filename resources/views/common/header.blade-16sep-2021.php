			...
			<?php
				...
				foreach ($parentCategories as $category) {
					...
					<ul class="sub-sub-menu-child sub-sub-menu">
							...
							<li><a href="{{route('products.list', ['pcat'=>$category->slug, 'p2cat'=>$childCat->slug])}}">{{$childCat->name}}</a> </li>
				...
				<?php } ?>
				  ...
				  if(!empty($collections) && count($collections) > 0) 
				  {
				   ...
				   ?>
				       ...
				       {
				       	?>
							<li><a href="{{url('products?')}}collection={{$collection->slug}}"><?php echo $collection->name; ?></a> </li>
				...
				?>				 
						...
						<img src="https://jpnewstatic.ehostinguk.com/background-image/top-menu-image.jpg" alt="JohnPride" border="0"> 
					</li>
