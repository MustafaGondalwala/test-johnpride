...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5KP42GB"
...
<div class="login_body loginBox">
	...
	<div class="logbox">
		...
		<div class="loginform">
			...
			<form name="loginForm" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="email" id="email_phone" value="{{old('email')}}" placeholder="Your Email ID" autocomplete="off" />

					@include('snippets.front.errors_first', ['param' => 'email'])

					<span style="color:#800000;" id="phone_required_error"></span>
				</div>
		...
		<div class="formbot">
			...
			<a href="javascript:void(0)" class="forgot_btn_show">Recover password</a> 
			<!-- <span>New to Johnpride ? <a class="show_reg" href="javascript:void(0)">Register</a></span> -->
