		...
		<div class="container">
			...
			<div class="fbox">
				...
				<ul>
					...
					<li><a href="{{url('our-store')}}">Our Stores</a></li>
					<li><a href="{{url('enquiry-form')}}">Franchise Enquiry</a></li>
			...
			<div class="fbox">
				...
				<ul> 
					...
					<li><a href="{{url('returns')}}">Return/Exchange Policy</a></li>
				</ul> 
			</div>
			...
			<div class="fbox">
				<h4>Help</h4>
				<ul> 
					<li><a href="{{url('redeem-store-credits')}}">Redeem Store Credits</a></li> 
					<li><a href="{{url('faqs')}}">FAQ</a></li> 
					<!-- <li><a href="{{url('returns')}}">Create Return/Exchange Request</a></li> -->					
		...
		<div class="close-btn">×</div>
			<div class="custom-model-wrap">
				<div class="pop-up-content-wrap">
					<div class="formSec">
						<div class="eicon">
							<img src="{{url('/')}}/images/service.png" class="img-fluid" alt="Enquire">
						</div>
						<div class="etitle">For any query</div>
						<div class="epara">please feel free to reach out to us!</div>
						<div class="con-list">
							<ul>
								<li><a href="tel:+91-9599969498"><img src="{{url('/')}}/images/phone.png" class="img-fluid" alt="Phone"> +91-9599969498</a></li>
								<li><a href="mailto:support@johnpride.in"><img src="{{url('/')}}/images/envelop.png" class="img-fluid" alt="Email"> support@johnpride.in</a></li>
							</ul>
						</div>
					</div>
				</div>  
...
<div class="popupbox">
  ...
  <div class="fullwidth logoimg"><img src="{{url('/')}}/images/logo.png" alt="JohnPride"  /></div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-203938058-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-203938058-1');
</script>
<noscript>
		  ...
		  else
		  {
		  	...
		  	$('#is_request_otp').val(1);
				...
				// OTP SENT AJAX CALL
					...
					$.ajax({
					url: "{{url('account/ajax_login_otp_send')}}",
					type: "POST",
...
$('#frmotpverify').submit(function(e)
{
	 ...
	 // alert(otp);
	  ...
	  $.ajax({
		url: "{{url('account/ajax_verify_otp')}}",
		type: "POST",
