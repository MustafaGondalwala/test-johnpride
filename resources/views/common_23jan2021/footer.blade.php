		...
		<div class="container">
			...
			<div class="fbox">
				...
				<ul>
					...
					<li><a href="{{url('')}}">Our Stores</a></li>
					<li><a href="{{url('about')}}">Franchise Enquiry</a></li>
			...
			<div class="fbox">
				...
				<ul> 
					...
					<li><a href="{{url('')}}">Redeem Store Credits</a></li> 
			...
			<div class="fbox">
				<h4>Policies</h4>
				<ul> 
					<li><a href="{{url('returns')}}">Shipping Policy</a></li>					
					<li><a href="{{url('faq')}}">Terms of Use</a></li> 
					<li><a href="{{url('')}}">Privacy Policy</a></li> 
					<li><a href="{{url('terms')}}">Disclaimer</a></li> 
