...
<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 10px 0;">
	...
	<td style="padding: 10px 40px 10px 40px; font-size: 14px;">
		If you need any assistance with your order, please e-mail us at <a href="mailto:support@johnpride.in">support@johnpride.in</a> or call us at +91 9599969498 (10 AM to 6 PM, working days ).
	</td>
</tr>
 
<tr>
	<td style="padding: 10px 40px 10px 40px;">
		<a href="{{url('users/orders/'.$subOrderNo)}}" style="font-size: 20px; font-family: 'Roboto', Arial, sans-serif; font-weight: 400; color: #fff; text-decoration: none; background-color: #A77736; padding: 10px 40px;">Track Order</a>
	</td>
</tr>
<tr>
