...
<tr>
	<td style="padding: 30px 0px 30px 40px;">
		...
		<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #626365; line-height: 32px;">
			...
			The customer care will shortly be in touch with you to provide the pick up details. The refund will be initiated once the product the courier partner successfully picks up the product and the TAT for refund in the selected mode is 10 working days from the return booking date.
...
<tr>
	<td style="padding: 30px 40px 60px 40px;">
		<a href="{{url('users/orders/'.$orderId)}}" style="font-size: 20px; font-family: Roboto; font-weight: 400; color: #fff; text-decoration: none; background-color: #A77736; padding: 10px 40px;">Track Order</a>
	</td>
</tr>
<tr bgcolor="#A77736">
