@component('admin.layouts.main')
   ...
   $facilities_arr = config('custom.facilities_arr');
    ...
    $value_of_points = (isset($loyaltyPointsMaster->value_of_points))?$loyaltyPointsMaster->value_of_points:'';
    $shipping_free_min_order = (isset($loyaltyPointsMaster->shipping_free_min_order))?$loyaltyPointsMaster->shipping_free_min_order:'';
                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ old('name', $name) }}" maxlength="100" readonly="" />
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group{{ $errors->has('value_of_points') ? ' has-error' : '' }}">
                                <label class="control-label required">Value of Points:</label>

                                <input type="text" name="value_of_points" class="form-control" value="{{ old('value_of_points', $value_of_points) }}" maxlength="20" />

                                @include('snippets.errors_first', ['param' => 'value_of_points'])
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group{{ $errors->has('shipping_free_min_order') ? ' has-error' : '' }}">
                                <label class="control-label required">Shipping Free Min Order:</label>

                                <input type="text" name="shipping_free_min_order" class="form-control" value="{{ old('shipping_free_min_order', $shipping_free_min_order) }}" maxlength="20" />

                                @include('snippets.errors_first', ['param' => 'shipping_free_min_order'])
                            </div>
                        </div>
