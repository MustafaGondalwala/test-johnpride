@component('admin.layouts.main')
    ...
    @slot('title')
        Admin - Upload Inventory(s) - {{ config('app.name') }}
    @endslot
            ...
            <form method="POST" action="" accept-charset="UTF-8" enctype="multipart/form-data" role="form">
                ...
                <p>
                    <span style="font-family: arial, sans-serif;"><i><b>Instructions on use:</b></i> <br>
                        ...
                        <a href="{{ url('assets/uploads/sample_upload_inventory.xlsx') }}" class="btn-link btn-xs">View Sample file</a></font><br><br>
                    </p>
