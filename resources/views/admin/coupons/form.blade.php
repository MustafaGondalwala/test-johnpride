@component('admin.layouts.main')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            $coupon_type = (isset($coupons->coupon_type))?$coupons->coupon_type:'';
            ...
            <form method="POST" action="{{ $action_url }}" accept-charset="UTF-8" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group{{ $errors->has('expiry_date') ? ' has-error' : '' }} col-md-6">
                   ...
                   <div class="form-group{{ $errors->has('coupon_type') ? ' has-error' : '' }} col-md-6">
                    <label for="type" class="control-label required">Coupon Type:</label>

                    <select name="coupon_type" class="form-control" >
                        <option value="">Select</option>
                        <option value="0" <?php echo ($coupon_type==0) ? 'selected':''; ?>>Internal</option>
                        <option value="1" <?php echo ($coupon_type==1) ? 'selected':''; ?>>External</option>
                    </select>

                    @include('snippets.errors_first', ['param' => 'coupon_type'])
                </div>
