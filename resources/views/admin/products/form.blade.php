...
<div class="row">
    ...
    $collection_id = (isset($product->collection_id))?$product->collection_id:0;
    ...
    $folder_path = (isset($product->folder_path))?$product->folder_path:'';
    ...
    $productCollections = isset($product->productCollections) ? $product->productCollections:'';
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group{{ $errors->has('collection_id') ? ' has-error' : '' }}">
                            ...
                            if(!empty($BrandList) && count($BrandList) > 0){
                                ...
                                <select name="collection_id[]" class="form-control" id="collection_id" multiple="">
                                    <!-- <option value="">--Select--</option> -->
                                    <?php
                                    foreach($BrandList as $bl){
                                        
                                        $selected = '';
                                        if(in_array($bl->id, $collectionsArr)){
                                            $selected = 'selected';
                                        }
                                        ?>
                            ...
                            ?>
                            @include('snippets.errors_first', ['param' => 'collection_id'])
                        </div>
                    </div>
                    ...
                    */
                    ...
                    <div class="col-sm-12 col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            <label class="control-label required">MRP Price:</label>
                    ...
                    <div class="col-sm-12 col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('gst') ? ' has-error' : '' }}">
                            ...
                            <select name="gst" class="form-control" disabled>
                                <option value="">--Select--</option>
                    ...
                    */
                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('desktop_image') ? ' has-error' : '' }}">
                            ...
                            <label class="control-label">Product Feature Desktop Image link (Recommended Size : 1200x600)</label>
                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('mobile_image') ? ' has-error' : '' }}">
                            ...
                            <label class="control-label">Product Feature Mobile Image link (Recommended Size : 600x600)</label>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group{{ $errors->has('folder_path') ? ' has-error' : '' }}">
                            <label class="control-label">Image Folder Path:</label>

                            <input type="text" class="form-control" name="folder_path" value="{{ old('folder_path', $folder_path) }}" />

                            @include('snippets.errors_first', ['param' => 'folder_path'])
                        </div>
                    </div>
...
$(".add_img_row").click(function(){
        ...
        if(img_row_len+1 > 6){
            alert('Maximum 6 Attributes are allowed.');
        }
        else{
