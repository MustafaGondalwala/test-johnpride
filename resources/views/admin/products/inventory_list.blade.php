        ...
        <div class="bgcolor">
            ...
            <div class="table-responsive">
                ...
                <form class="form-inline" method="GET">
                    <div class="col-md-3">
                        <label>SKU:</label><br/>
                        <input type="text" name="sku" class="form-control admin_input1" value="{{$old_sku}}">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{url('admin/products/inventory_list')}}" class="btn resetbtn btn-primary btn1search" >Reset</a>
                    </div>
                </form>
            </div>
        </div>
