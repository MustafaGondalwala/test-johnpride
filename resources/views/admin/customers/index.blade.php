            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped">
                    ...
                    foreach($customers as $customer){
                        ...
                        $loyaltyPointsDetails = CustomHelper::findLoyaltyPonitsCriteria($customer_id,$orderAmount=0,$show=true);



                       $loyaltyPointsDetailsForName = CustomHelper::findLoyaltyPonitsCriteriaForName($customer_id,$orderAmount=0,$show=true);
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                { ?>
                                    <a href="{{ route('admin.customers.loyalty-points', [$customer_id, 'back_url'=>$BackUrl]) }}" title="User Loyalty Points" ><strong><?php echo $loyaltyPointsDetails['name']; ?></strong></a>
                                <?php 
                            }*/
                             ...
                             if(!empty($loyaltyPointsDetailsForName) && $loyaltyPointsDetailsForName['haveCriteria'])
                               { 
                                    ?>
                                    <a href="{{ route('admin.customers.loyalty-points', [$customer_id, 'back_url'=>$BackUrl]) }}" title="User Loyalty Points" ><strong><?php echo $loyaltyPointsDetailsForName['name']; ?></strong></a>
                                <?php 
                              }
                            ...
                            <td>
                                 ...
                                 <a target="_blank" href="<?php echo url('users/'.$customer->id.'/impersonate') ?>" title="Login as Customer">Login</i></a>
                                ...
                                <a href="{{ route('admin.customers.loyalty-points', [$customer_id, 'back_url'=>$BackUrl]) }}" title="User Loyalty Points" ><i aria-hidden="true" class="fa fa-trophy" ></i></a>
                            </td>
                        </tr>
                        <?php
                    }
