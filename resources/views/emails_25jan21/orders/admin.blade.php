...
@slot('heading')
<td align="left" style="color: #fff; font-size: 20px; padding: 20px 40px;">Order Confirmed </td>
@endslot

@slot('headingIcon')
<td align="right" style="padding-right: 40px;">
	<img src="<?php echo url('images/checkicon.png'); ?>" alt="icon" width="59" height="59" style="margin-top: -50px;">
</td>
@endslot
...
<tr>
	<td style="padding: 30px 40px 60px 40px;">
		<a href="{{url('admin/orders')}}" style="font-size: 20px; font-family: Roboto; font-weight: 400; color: #fff; text-decoration: none; background-color: #A77736; padding: 10px 40px;">Track Order</a>
	</td>
</tr>
<tr bgcolor="#A77736">
