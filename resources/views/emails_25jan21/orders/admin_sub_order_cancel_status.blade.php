...
<tr>
	<td style="padding: 30px 0px 30px 40px;">
		...
		<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #626365; line-height: 32px;">
			...
			This Order has been Cancelled Successfully. Please find the order details.<br>
...
<tr>
	<td style="padding: 30px 40px 60px 40px;">
		<a href="{{url('users/orders/'.$subOrderNo)}}" style="font-size: 20px; font-family: Roboto; font-weight: 400; color: #fff; text-decoration: none; background-color: #A77736; padding: 10px 40px;">Track Order</a>
	</td>
</tr>
<tr bgcolor="#A77736">
