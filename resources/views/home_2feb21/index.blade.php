...
HOME_HEADING_3
HOME_HEADING_4*/
$websiteSettingsNamesArr = ['HOME_VIDEO', 'HOME_HEADING_1', 'HOME_HEADING_2', 'HOME_HEADING_3', 'HOME_HEADING_4', 'HOME_HEADING_5', 'HOME_HEADING_6', 'HOME_HEADING_7','NEWSLETTER_BACKGROUND_IMAGE','HOME_IMAGE_1'];
...
<section class="celebratesec fullwidth">
  <div class="bgimg1" style="background:url({{$HOME_IMAGE_1}}) center center no-repeat; background-size:cover;"></div>
  <div class="container">
    <div class="fullwidth headsec">
        ...
        <div class="probox">
          <div class="cimg">
            ...
            <?php if(!empty($product_image)){ ?>
              <div class="pimg">
             <a href="<?php echo url('products/details/'.$productPopular->slug); ?>"> <img src="{{$product_image}}" alt="{{$product_name}}" /> </a>
             </div>
            <?php } ?>
          </div>
          <div class="procont">
...
<section class="newtosec fullwidth" style="background: url({{$NEWSLETTER_BACKGROUND_IMAGE}}) center center no-repeat; background-size:cover;">
  ...
  <div class="container">
    ...
    <div class="fullwidth instagramslid owl-carousel">
      ...
      foreach ($instaMedia->data as $vm){
        ...
        $img = '';
        if(!empty($media_content_by_id) && count($media_content_by_id) > 0){

          $media_type = isset($media_content_by_id->media_type) ? $media_content_by_id->media_type:'';

          if(!empty($media_type) && $media_type == 'CAROUSEL_ALBUM' || $media_type == 'IMAGE') {
            $img = isset($media_content_by_id->media_url) ? $media_content_by_id->media_url:'';
            ?>
            <div class="instaimg">
              <a href="https://www.instagram.com/johnprideclothing/" target="_blank">
                <img target="_blank" src="{{$img}}" alt="Instagram" />
              </a> 
            </div>
            <?php
          }
