...
<html lang="en">
   <head>
      <style>
         ...
         .insta_images {    background-size: cover !important; background-position: center center !important;display: block;}
         .newtosec {   background-size: cover !important; background-position: center center !important;}
        
         @media (max-width: 500px){
         .home .banner .owl-item img {
         height: initial !important;
         }
         .home .banner .owl-item > div {height: initial !important;}
         }
      </style>
      @include('common.head-home')
   ...
   <body class="home">
      ...
      <?php
         ...
         $websiteSettingsNamesArr = ['HOME_VIDEO', 'HOME_HEADING_1', 'HOME_HEADING_2', 'HOME_HEADING_3', 'HOME_HEADING_4', 'HOME_HEADING_5', 'HOME_HEADING_6', 'HOME_HEADING_7','NEWSLETTER_BACKGROUND_IMAGE','NEWSLETTER_BG_MOBILE_IMAGE','HOME_IMAGE_1','SUB_TITLE_1','SUB_TITLE_2','SUB_TITLE_3'];
         ...
         $NEWSLETTER_BG_MOBILE_IMAGE = (isset($websiteSettingsArr['NEWSLETTER_BG_MOBILE_IMAGE']))?$websiteSettingsArr['NEWSLETTER_BG_MOBILE_IMAGE']->value:'';
      ...
      <?php if(!empty($banners) && count($banners) > 0){
         //pr($banners);   ?> 
      <div class="banner owl-carousel fullwidth">
         <?php
            $path = 'banners/';
         ...
         <div style="background: url('{{url('storage/banners/'.$image->name)}}') center center no-repeat; background-size:cover;">
            ...
            <a href="{{$link}}" target="_blank">
               ...
               <?php 
                  ...
                  {
                    ?>
               <img src="{{url('storage/banners/'.$image->name)}}" alt="{{$banner->title}}" class="show_mobile_banner" />
               <?php
                  }
                  else
                  {
                  ...
                  if(!empty($collections) && count($collections) > 0){ 
                    ...
                    foreach($collections as $collection){
                  ...
                  
                      {
                        ...
                        $collection_url = url('collections/'.$collection->slug);

                  
                        ?>
               <a href="<?php echo $collection_url; ?>" class="cimg">
      ...
      <?php 
         $news_bg_img = $NEWSLETTER_BACKGROUND_IMAGE;
         
         if($isMobile)
         
         {
         
          $news_bg_img = $NEWSLETTER_BG_MOBILE_IMAGE;
         
         }
         
         ?>
      <div class="newtosec fullwidth showpopup lazy"  style="background:url({{$image_path.$news_bg_img}})">
            ...
            <div class="fullwidth scochlist">
               ...
               <ul>
                  ...
                  <li>
                     ...
                     <img src="{{ url('storage/'.$path.'thumb/'.$customerPicture->image) }}" class="scotchpic lazy" alt="{{$customerPicture->title}}" />
                     <?php } ?>
                     </a>
                     <div class="popupmain">
                        ...
                        <div class="scotchpopup">
                           ...
                           <div class="scotchimg">
                              ...
                              <?php if(!empty($customerPicture->image) && $storage->exists($path.$customerPicture->image)){ ?>
                              <img src="{{ url('storage/'.$path.''.$customerPicture->image) }}" class="scotchpic lazy" alt="{{$customerPicture->title}}" />
                              <?php } ?>
                           </div>
                           <div class="scotchproduct">
                              <div class="scotchtitle">
                                 <div class="heading2">
                                    ...
                                    <span>{{$customerPicture->title}}</span>
                                 </div>
                              </div>
                              <div class="shoplook">
  ...
  if(isset($featuredBlog->Images) && !empty($featuredBlog->Images)) 
  {
    $blog_image = isset($featuredBlog->Images[0]->image) ? $featuredBlog->Images[0]->image : '';
  }
               ...
               <ul>
                  ...
                  <li>
                     <a class="cimg viewimg dd">
                        ...
                        <div class="pimg">
                           <img class="lazy" src="{{ url('storage/'.$path.'thumb/'.$lookBook->image) }}" alt="{{$lookBook->title}}" />
                        </div>
                        <?php } ?>
                     ...
                     <div class="popupmain">
                        ...
                        <div class="scotchpopup">
                           ...
                           <div class="scotchproduct">
                              <div class="scotchtitle">
                                 <div class="heading2"> <span>{{$lookBook->title}}</span></div>
                              </div>
                              <div class="shoplook">
                                 <div class="heading3">Shop The Look</div>
                                 <div class="probox">
      ...
      <div style="display: none;"><?php //echo "<pre>";print_r($instaMedia); ?></div>
      <?php
