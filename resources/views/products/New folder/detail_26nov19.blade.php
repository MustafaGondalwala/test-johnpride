	...
	<div class="container"> 
		...
		if(!empty($product->productImages) && count($product->productImages) > 0){
			...
			<ul class="dtimg">
				...
				$productImages = $product->productImages->take(5);
				...
				foreach ($productImages as $image){
					...
					if(!empty($image->image)){
						?>
						<li>
							<a href="{{$image->image}}" data-imagelightbox="g">
	  ...
	  ?>
		...
		<div class="dtright">
			...
			<div class="pricetitle ">
				...
				<p class="cash_back">(cash backs, extra 10% off on shopping above 1500/- & so on…)</p>
