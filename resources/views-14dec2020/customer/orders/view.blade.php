...
<section class="fullwidth accountpage">	
	<div class="container">
        ...
        if(!empty($res) && $res->count() > 0){
				...
				<div class="row"> 
				 <div class="col-md-6 form-group addressfilds">
					 <h4><strong>Billing Address</strong></h4>
                        ...
                        <p><span>Landmark :</span> {{$res->billing_locality}}</p>
          ...
          <p><span>Landmark :</span> {{$res->shipping_locality}}</p>
            ...
            <div class="table-responsive"> 
                ...
                <table class="table bordermain headth table-hover">
                    ...
                    <tr>
                      ...
                      <?php if($res->loyalty_discount > 0){?>

                        <tr>
                            <td></td>
                            <td></td>
                            <td><b>Loyalty Discount</b></td>
                            <td>{{$res->loyalty_discount}}</td>
                        </tr>
