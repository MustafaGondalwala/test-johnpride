    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ url('admin/states/save') }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add State</a>            
                ...
                <form class="form-inline" method="GET">
                   ...
                   <!--  <div class="clearfix"></div> -->                    
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{url('admin/states')}}" class="btn resetbtn btn-primary btn1search">Reset</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            {{ $states->appends(request()->query())->links() }}
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    foreach ($states as $state){
                        ...
                        $countryName = (isset($state->country->nicename))?$state->country->nicename:'';
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.states.save', ['id'=>$state->id,'back_url'=>$BackUrl])}}" title="Edit"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                        <?php
                    }
