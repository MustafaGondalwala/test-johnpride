@component('admin.layouts.main')
    ...
    $banner_image = (isset($category->banner_image))?$category->banner_image:'';
    $mob_banner_image = (isset($category->mob_banner_image))?$category->mob_banner_image:'';
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('banner_image') ? ' has-error' : '' }}">
                            ...
                            <label class="control-label">Banner Image Link:</label>

                            <input type="text" class="form-control" name="banner_image" value="{{ old('banner_image', $banner_image) }}" />

                            @include('snippets.errors_first', ['param' => 'banner_image'])
                        </div>

                        <div class="form-group{{ $errors->has('mob_banner_image') ? ' has-error' : '' }}">

                            <label class="control-label">Mobile Banner Image Link:</label>

                            <input type="text" class="form-control" name="mob_banner_image" value="{{ old('mob_banner_image', $mob_banner_image) }}" />

                            @include('snippets.errors_first', ['param' => 'mob_banner_image'])
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    foreach($categoryImages as $ci){
                                        ...
                                        if(!empty($image) && $storage->exists($thumb_path.$image)){
                                            ...
                                            $target_path = url('storage/'.$thumb_path.$image);

                                            if($storage->exists($path.$image)){
                                                $target_path = url('storage/'.$path.$image);
                                            }
                                            ?>
                                            <tr>
                                                <td>

                                                    <a href="{{$target_path}}" target="_blank"><img src="{{url('storage/'.$thumb_path.$image)}}" width="100" /></a>
                                                </td>
