    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ url('admin/countries/save') }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add Country</a>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    foreach ($res as $rec)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.countries.save', ['id'=>$rec->id,'back_url'=>$BackUrl])}}" title="Edit"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                        <?php
                    }
