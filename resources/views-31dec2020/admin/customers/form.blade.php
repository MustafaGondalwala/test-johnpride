...
$wedding_anniversary = (isset($customer->wedding_anniversary) && $customer->wedding_anniversary && $customer->wedding_anniversary !='0000-00-00')?$customer->wedding_anniversary:'';
...
$wedding_anniversary = CustomHelper::DateFormat($wedding_anniversary, $toFormat='d/m/Y', $fromFormat='Y-m-d');
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group{{ $errors->has('wedding_anniversary') ? ' has-error' : '' }}">
                    <label class="control-label">Date of Merriage Anniversary:</label>

                    <input type="text" name="wedding_anniversary" class="form-control inputDate" value="{{ old('wedding_anniversary', $wedding_anniversary) }}" readonly />

                    @include('snippets.errors_first', ['param' => 'wedding_anniversary'])
                </div>
            </div>
