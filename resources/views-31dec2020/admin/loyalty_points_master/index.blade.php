                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            <!-- <th>ID</th> -->
                            <th>Name</th>
                            <th>Points needed <br /> Min/Max</th>
                            <th>Value of Points</th>
                            <th>Min Order <br />Amount</th>
                            <th>Shipping Free <br />Min Order</th>
                            <!-- <th>Facilities</th> -->
                            <th>Status</th>
                            <th>Action</th>
                        </tr>
                        ...
                        <tr>
                           <!--  <td>{{$lpm->id}}</td> -->
                            <td>{{$lpm->name}}</td>
                            <td>{{$lpm->points_needed}} / <?php if($lpm->points_needed_max > 0){echo $lpm->points_needed_max; }else{ echo 'No Limit'; } ?></td>
                            <td>{{$lpm->value_of_points}}</td>
                            <td>{{$lpm->min_order_amount}}</td>
                            
                            <td>{{$lpm->shipping_free_min_order}}</td>
                            <?php /* ?>
                            <td>
                                <?php 
