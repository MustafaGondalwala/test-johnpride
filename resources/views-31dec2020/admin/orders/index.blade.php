							...
							<td colspan="6">
								<table class="table table-striped">
													...
													foreach ($orderItems as $item) {	
														...
														$subOrderStatusDetails = $item->subOrderStatusDetails;
														...
														<tr>
															...
															<p>
															<span>
																Sub Order No: {{$item->sub_order_no}}</span>
															</p>
															<p>
															...
															<div class="procont">
																...
																<div class="cartprice"><span>Rs <?php echo number_format($productPrice);?></span></div>
