...
<div class="row">
	<div class="col-md-12">
		<div class="titlehead">
			...
			<a href="javascript:void(0)" data-id="{{ $order->id }}" class="print_invoice noPrint btn btn-sm btn-success pull-right">Print Invoice</a>
		</div>
	</div>
</div>
...
if(!empty($order) && $order->count() > 0){
	...
	<div class="table-responsive ordership orders_view">
		<div class="orderheading">
			<div class="col-sm-4">
				<label>Order Id :</label><br>{{$order->id}}
			</div>
			<div class="col-sm-8">
				...
				<tr>
					<td>
						<select class="form-control" name="payment_status">
							...
							<option value="receieved" <?php if($order->payment_status == 'receieved') { echo 'selected'; } ?> >Received</option>
