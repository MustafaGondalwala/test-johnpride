...
<tr>
	<td style="padding: 30px 0px 30px 40px;">
		...
		<p style="font-size: 14px; font-family: 'Roboto', sans-serif, Arial; color: #626365; line-height: 32px;">
			...
			?>
			Thank You for shopping @ <a href="www.Slumberjill.in">www.Slumberjill.in</a> Your Orders has been Dispatched.<br>
...
<tr>
	<td style="padding: 10px 40px 10px 40px;">
		<a href="{{url('users/orders/'.$orderId)}}" style="font-size: 20px; font-family: 'Roboto', Arial, sans-serif; font-weight: 400; color: #fff; text-decoration: none; background-color: #A77736; padding: 10px 40px;">Track Order</a>
	</td>
</tr>
<tr>
